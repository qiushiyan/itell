...
The **GDP deflator** is a price index measuring the average prices of all goods and services included in the economy. We explore price indices in detail and how we compute them in chapter on inflation, but this definition will suffice in the context of this chapter. Table 5.5 provides the GDP deflator data and Figure 5.8 shows it graphically.
...
$$
\text{Value} = \text{Price} × \text{Quantity} \\
\text{or} \\
...
$$
\begin{aligned}
\text{Coolshirt's nominal revenue from sales} &= \text{Price x Quantity} \\
&= \text{\$9 × 10} \\
&= \text{\$90}
\end{aligned}
$$
...
<strong>Computing GDP</strong>

We can use the data in Table 5.5 to compute real GDP.

**Step 1.** Look at [Table 5.5](6-2-adjusting-nominal-values-to-real-values#Table_19_05), to see that, in 1960, nominal GDP was $543.3 billion and the price index (GDP deflator) was 19.0.

**Step 2.** To calculate the real GDP in 1960, use the formula:

$$
\begin{aligned}
\text{Real GDP} &= (\text{Nominal GDP} × 100) / \text{Price Index} \\
&= \text{\$543 billion} × 100 / 19 \\
&= \text{\$2,859.5 billion}
\end{aligned}
$$
...
**Step 4.** Continue using this formula to calculate all of the real GDP values from 1960 through 2010. The calculations and the results are in [Table 5.6].
...
$$
\begin{aligned}
\text{Nominal} &= \text{Price} x \text{Quantity} \\
