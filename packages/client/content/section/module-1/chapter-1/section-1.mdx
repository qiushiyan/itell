...
<Accordion
  items={[
    {
      label:
        "1. Workers specialize in particular tasks where they have an advantage.",
      content: (
        <p>
          <strong>Specialization</strong> in a particular task allows workers to
    ...
    {
      label:
        "2. Workers who specialize work faster and produce higher quality.",
      content: (
        <p>
    ...
    {
      label: '3. Businesses take advantage of "economies of scale".',
      content: (
        <p>
          Specialization allows businesses to take advantage of
          <strong> economies of scale</strong>, which means that for many goods,
