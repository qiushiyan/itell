...
<Accordion
  items={[
    {
      label: "Changing Tastes or Preferences",
      content: (
        <p>
    ...
    {
      label: "Changes in the Composition of the Population",
      content: (
        <p>
    ...
    {
      label: "Changes in the Prices of Related Goods",
      content: (
        <div>
          Changes in the prices of related goods such as substitutes or
          complements also can affect the demand for a product. A <strong>substitute </strong>
...
**missing Carousels & (context below) here**

https://intromacro.econ.gatech.edu/chapter-3/
...
Step 1.
Draw the graph of a demand curve for a normal good like pizza. Pick a price (like P0). Identify the corresponding Q0. [Figure 3.6](3-2-shifts-in-demand-and-supply-for-goods-and-services#CNX_Econ_C03_019).

![The graph represents the directions for step 1.A demand curve shows how much consumers would be willing to buy at any given price.](figure/9e1955ed4c9ab8bbb1bbcbb2693b139f7c07d3c2.png)

Step 2.
Suppose income increases. As a result of the change, are consumers going to buy more or less pizza? The answer is more. Draw a dotted horizontal line from the chosen price, through the original quantity demanded, to the new point with the new Q1. Draw a dotted vertical line down to the horizontal axis and label the new Q1. [Figure 3.7](3-2-shifts-in-demand-and-supply-for-goods-and-services#CNX_Econ_C03_020) provides an example.

![The graph represents the directions for step 2. With an increased income, consumers will wish to buy a higher quantity (Q sub 1) than they bought with a lower income.](figure/06d7bdd640c57df2d61eeed3da04737c2315eadb.png)

Step 3.
Now, shift the curve through the new point. You will see that an increase in income causes an upward (or rightward) shift in the demand curve, so that at any price the quantities demanded will be higher.

![The graph represents the directions for step 3. An increased income results in an increase in demand, which is shown by a rightward shift in the demand curve.](figure/3afa9ea65b28cbd996c45ad7540629aebaca8887.png)
...
<Accordion items={[
  {
    label: "Changes in Weather or Other Natural Conditions",
    content: <div>
...
{
label: "Changing Technologies of Production",
content:
...
{
label: "Changes in Government Policies",
content: <div>
...
![The graph represents the directions for step 1. A supply curve shows the minimum price a firm will accept (P sub 0) to supply a given quantity of output (Q sub 0).](figure/3e369f736dc2d4425b2c5b71139a13ca87436c90.png)
...
![The graph represents the directions for step 2. For a given quantity of output (Q sub 0), the firm wishes to charge a price (P sub 0) equal to the cost of production plus the desired profit margin.](figure/a379c135419a9d70d1bf401e706325fad2f44b0b.png)
...
![The graph represents the directions for step 3. An increase in production cost will raise the price a firm wishes to charge (to P sub 1) for a given quantity of output (Q sub 0).](figure/0ae5928877379c56d813e8c891bfd1afb6abfbd0.png)

Step 4
Shift the supply curve through this point. You will see that an increase in cost causes an upward (or a leftward) shift of the supply curve so that at any price, the quantities supplied will be smaller, as [Figure 3.14](3-2-shifts-in-demand-and-supply-for-goods-and-services#CNX_Econ_C03_025) illustrates.

![The graph represents the directions for step 4. An increase in the cost of production will shift the supply curve vertically by the amount of the cost increase.](figure/2f7816ce7b24d7b056a5510c60d5cf8d0b60c591.png)
