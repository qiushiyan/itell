...
<div className = "chunk" data-chunk-slug = "intro">
...
<div className = "chunk" data-chunk-slug = "floor-division-and-modules">
...
<div className = "chunk" data-chunk-slug = "boolean-expressions">
...
<div className = "chunk" data-chunk-slug = "logical-operators">
...
<div className = "chunk" data-chunk-slug = "conditional-execution">
...
<div className = "chunk" data-chunk-slug = "alternative-execution">
...
<div className = "chained-conditionals" data-chunk-slug = "chained-conditionals">
...
<div className = "chunk" data-chunk-slug = "nested-conditionals">
...
<div className = "chunk" data-chunk-slug = "recursion">
...
<div className = "chunk" data-chunk-slug = "stack-diagrams-for-recursive-functions">
...
<div className = "chunk" data-chunk-slug = "infinite-recursion">
...
<div className = "chunk" data-chunk-slug = "keyboard-input">
...
<div className = "chunk" data-chunk-slug = "debugging">
...
<div className = "glossary" data-chunk-slug = "glossary">
...
<div className = "chunk" data-chunk-slug = "exercises">
