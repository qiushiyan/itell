...
<div className = "chunk" data-subsection-id = "assignment-statements">
...
<div className = "chunk" data-subsection-id = "variable-names">
...
<div className = "chunk" data-subsection-id = "expressions-and-statements">
...
<div className = "chunk" data-subsection-id = "script-mode">
...
<div className = "chunk" data-subsection-id = "order-of-operations">
...
<div className = "string-operations" data-subsection-id = "string-operations">
...
<div className = "chunk" data-subsection-id = "comments">
