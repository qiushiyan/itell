...
Now let's start by practicing `print`! Replace `<my-name>` with your name and run this code.
  ...
  <CodeEditor script="chapter-1/print.py" />
</CodingTime>
...
<CodeEditor script="chapter-1/arithmetic.py" />
...
<CodeEditor script="chapter-1/type.py" />
...
<CodeEditor code="# try the exercise below" />
