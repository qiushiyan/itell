...
<Notebook script="chapter-1/print.py" />
  ...
  <Warning title = "A note on using print in the textbook editor">
    Due to a technical limitation, the python environment for this textbook currently only shows the result of `print` statements if it is the **last line** of a cell. If you want to have multiple print statements, you can create multiple cells for each of them, like in the following example.

    <Notebook script = "chapter-1/warning-print.py" />
