...
of thinking combines some of the best features of mathematics, engineering, and natural
...
<div className = "chunk" data-subsection-id = "what-is-a-program">
...
<div className = "chunk" data-subsection-id="running-python">
...
<div className = "chunk" data-subsection-id = "the-first-program">
...
<div className = "chunk" data-subsection-id="arithmetic-operators">
...
<div className = "chunk" data-subsection-id = "values-and-types">
...
<div className = "chunk" data-subsection-id = "formal-and-natural-languages">
