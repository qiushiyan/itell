...
<Accordions>
  <Accordion value={"Changing Tastes or Preferences"}>
  ...
  <Accordion value={"Changes in the Composition of the Population"}>
  ...
  <Accordion value={"Changes in the Prices of Related Goods"}>
  ...
  <Accordion value="Changes in Expectations about Future Prices">
...
<Stepper value={1}>
  ...
  <StepperBody>
    ...
    <Image alt="The graph represents the directions for step 1.A demand curve shows how much consumers would be willing to buy at any given price." src="/images/module-1/chapter-3/section-2/9e1955ed4c9ab8bbb1bbcbb2693b139f7c07d3c2.png" width={400} height={300}/>
    ...
    <StepperPanel value={2}>
      <Image alt="The graph represents the directions for step 2. With an increased income, consumers will wish to buy a higher quantity (Q sub 1) than they bought with a lower income." src="/images/module-1/chapter-3/section-2/06d7bdd640c57df2d61eeed3da04737c2315eadb.png" width={400} height={300}/>
    ...
    <StepperPanel value={3}>
     <Image alt="The graph represents the directions for step 3. An increased income results in an increase in demand, which is shown by a rightward shift in the demand curve." src="/images/module-1/chapter-3/section-2/3afa9ea65b28cbd996c45ad7540629aebaca8887.png" width={400} height={300}/>
...
<Accordions>
  <Accordion value="Changes in Weather or Other Natural Conditions">
  ...
  <Accordion value="Changing Technologies of Production">
  ...
  <Accordion value="Changes in Government Policies">
...
<Stepper value={1}>
  ...
  <StepperBody>
    <StepperPanel value={1}>
    <Image alt="The graph represents the directions for step 1. A supply curve shows the minimum price a firm will accept (P sub 0) to supply a given quantity of output (Q sub 0)." src="/images/module-1/chapter-3/section-2/3e369f736dc2d4425b2c5b71139a13ca87436c90.png" width={400} height={300}/>
    ...
    <StepperPanel value={2}>
      <Image alt="The graph represents the directions for step 2. For a given quantity of output (Q sub 0), the firm wishes to charge a price (P sub 0) equal to the cost of production plus the desired profit margin." src="/images/module-1/chapter-3/section-2/a379c135419a9d70d1bf401e706325fad2f44b0b.png" width={400} height={300}/>
    ...
    <StepperPanel value={4}>
      <Image alt="The graph represents the directions for step 4. An increase in the cost of production will shift the supply curve vertically by the amount of the cost increase." src="/images/module-1/chapter-3/section-2/2f7816ce7b24d7b056a5510c60d5cf8d0b60c591.png" width={400} height={300}/>
