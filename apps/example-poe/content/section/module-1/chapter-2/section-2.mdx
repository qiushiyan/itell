...
<Tabs value="productive">
  ...
  <TabsBody>
    ...
    education along the production possibilities frontier—as a ray (line) from
    the origin to a specific point on the PPF. Output mixes that have more
    healthcare and less education would have a steeper ray, while those with
    more education and less healthcare would have a flatter ray.
    </TabPanel>
