...
<Image src="/images/module-1/chapter-4/section-3/7fcc913a62b0f82b5cbda70cd269a6b503f8258c.png" alt="The graph shows a straightforward example of standard supply and demand curves that intersect at equilibrium." floatLeft width={400} height={300}>
...
The theory of supply and demand can explain what happens in the labor markets and suggests that the demand for nurses will increase as healthcare needs of baby boomers increase, as [Figure 4.10](4-3-the-market-system-as-an-efficient-mechanism-for-information#CNX_Econ_C04_015) shows. The impact of that increase will result in an average salary higher than the $67,490 earned in 2015 referenced in the first part of this case. The new equilibrium (E1) will be at the new equilibrium price (Pe1).Equilibrium quantity will also increase from Qe0 to Qe1.

<Image src="/images/module-1/chapter-4/section-3/19a7e8ccdd1aef2d52096ca2708df638978562a3.png" alt="The graph shows an increase in the demand for and nurses from D0 to D1." floatLeft width={400} height={400}>
...
<Image src="/images/module-1/chapter-4/section-3/ad6a6436b311cb82ddc371cdd25af062eefccc7c.png" alt="The graph shows increases in both the supply and demand for nurses and its effect on equilibrium price and quantity" floatLeft width={400} height={400}>
