...
<div className="grid grid-cols-2 gap-4">
  <div className="col-span-1">
    ...
    unchanged between the equilibria E0, E1, and E2, all unemployment in this
...
<Image alt='This graph shows several points of intersection between unemployment rates and inflation rates, one point for each year. Horizontal dashed lines extend from the y-axis at 5%, 4%, 3%, 2%, 1% and 5%. Vertical dashed lines extend from the x-axis at 2%, 3%, 4%, 6% and 4%. The points of intersection between these various lines are (2, 3); (3, 3), (4, 1); (4, 2); (4, 5); (6, 1); (5, 4).'  src='/images/module-3/chapter-12/section-2/49b2ba17897e5689840c580b3135c3ce9f5cdf9b.png' floatLeft width={400} height={300}>
**Figure 12.6** Inflation and Unemployment Rates

</Image>

**Step 1:** Plot the data points in a graph with inflation rate on the vertical axis and unemployment rate on the horizontal axis. Your graph will appear similar to Figure 12.6.
...
**Step 3:** Can you determine the natural rate of unemployment from the data or from the graph? As you analyze the graph, notice that the natural rate of unemployment lies at 4%. This is the rate that the economy appears to adjust back after an apparent change in the economy.
...
The unemployment rate on the long-run Phillips curve will be the natural rate of unemployment (Figure 12.5 (a) and (b)). A small inflationary increase in the price level from AD<sub>0</sub> to AD<sub>1</sub> will have the same natural rate of unemployment as a larger inflationary increase in the price level from AD<sub>0</sub> to AD<sub>2</sub>. The macroeconomic equilibrium along the vertical aggregate supply curve can occur at a variety of different price levels, and the natural rate of unemployment can be consistent with all different rates of inflation.
