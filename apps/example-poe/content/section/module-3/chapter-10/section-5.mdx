...
In the short run, GDP falls and rises as every economy dips into or expands out of recession. The AD/AS diagram illustrates recessions when the equilibrium level of real GDP is substantially below potential GDP, as we see at the equilibrium point E0 in **Figure 10.9**. From another standpoint, in years of resurgent economic growth, the equilibrium will typically be close to potential GDP, as equilibrium point E1 in **Figure 11.9** shows.
...
<div className="grid grid-cols-2 gap-4">
  <div className="col-span-1">
    (a) A shift in aggregate demand, from AD0 to AD1, when it happens in the
    ...
    equilibrium (E1) is at a higher price level (P1) than the original
    equilibrium.
  </div>
  <div className="col-span-1">
    (b) A shift in aggregate supply, from SRAS0 to SRAS1, will lead to a lower
    real GDP and to pressure for a higher price level and inflation. The new
    equilibrium (E1) is at a higher price level (P1), while the original
    equilibrium (E0) is at the lower price level (P0).
  </div>
</div>
