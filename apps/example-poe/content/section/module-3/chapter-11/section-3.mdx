...
<Stepper value='1'>
    ...
    <StepperBody>
        ...
        <StepperPanel value='9'>
            ...
            <Image alt='The Phillips Curve shows a clear negative relationship between the unemployment rate and the inflation rate over the period 1960-69.' src='/images/module-3/chapter-11/section-3/cf44efab4ab137ca4a210925e830955da24d5ecc.png' width={500} height={400}  />
        ...
        <StepperPanel value='10'>
            <Image alt='The tradeoff between unemployment and inflation appeared to break down during the 1970s as the Phillips Curve shifted out to the right, meaning a given unemployment rate corresponds to a variety of rates of inflation and vice versa.' src='/images/module-3/chapter-11/section-3/ced6438ba96bca175bab8b13c901dbf0f9f0bbe2.png' width={500} height={400} />
