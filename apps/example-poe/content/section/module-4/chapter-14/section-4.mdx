...
<Image alt='This graph shows how monetary policy shifts the supply of loanable funds.' src='/images/module-4/chapter-14/section-4/2c9e3cbaa5f45230aa309098503c1d1ff665cf36.png' floatLeft width={400} height={300}>

**Figure 14.6** Monetary Policy and Interest Rates

</Image>

The original equilibrium (E0) occurs at an 8% interest rate and a quantity of \$10 billion in funds loaned and borrowed. An expansionary monetary policy will shift the supply of loanable funds to the right from the original supply curve (S0) to S1, leading to an equilibrium (E1) with a lower 6% interest rate and a quantity of \$14 billion in loaned funds. Conversely, a contractionary monetary policy will shift the supply of loanable funds to the left from the original supply curve (S0) to S2, leading to an equilibrium (E2) with a higher 10% interest rate and a quantity of \$8 billion in loaned funds.
