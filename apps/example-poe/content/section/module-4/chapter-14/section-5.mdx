...
<Image alt='This graph shows the neo-classical view that in the long run, monetary policy only affects the price level, not output.' src='/images/module-4/chapter-14/section-5/e741522de73fa7e1c5d1a36e6db3f1e5ffa55eda.png' floatLeft width={400} height={400}>
