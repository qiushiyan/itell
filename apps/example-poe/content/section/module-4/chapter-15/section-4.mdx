...
TThe original equilibrium occurs at E0, the intersection of aggregate demand curve AD0 and aggregate supply curve SRAS0, at an output level of 200 and a price level of 90.

One year later, aggregate supply has shifted to the right to SRAS1 in the process of long-term economic growth, and aggregate demand has also shifted to the right to AD1, keeping the economy operating at the new level of potential GDP. The new equilibrium(E1) is an output level of 206 and a price level of 92.

One more year later, aggregate supply has again shifted to the right, now to SRAS2, and aggregate demand shifts right as well to AD2. Now the equilibrium is E2, with an output level of 212 and a price level of 94.
...
<Image alt='The graph shows two aggregate demand curves that each intersect with an aggregate supply curve. Aggregate demand curve (AD sub 1) intersects with both the aggregate supply curve (AS sub 0) as well as the potential GDP line.' src='/images/module-4/chapter-15/section-4/f49cd0d360bd89e3b2448f0b60f99384141a65da.png' width={400} height={400} >
